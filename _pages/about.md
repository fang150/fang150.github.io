...
* Happy to announce that our paper on the Pricing Model was accepted in [Amazon Machine Learning Conference (AMLC) Pricing Workshop](https://www.amazon.science/), Oct 2024. (**We showed that via pertaining from multiple distributions of samples, the pricing model can reach flatter minima, via measuring the flatness of multimillion parameters loss landscape, which means better generalization, and most importantly, setting the price more accurately.**)
